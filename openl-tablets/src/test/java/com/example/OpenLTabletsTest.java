...
import com.example.openl_tablets.OpenLTablets;

public class OpenLTabletsTest {
    private Servicio servicio;
    private Base reglas;
    private OpenLTablets openLTablets;
    ...
    public void setup() {
        ...
        openLTablets= new OpenLTablets(servicio);
    }

    @Test
    public void descendientePrimerGrado() {
        assertEquals(reglas.calcularCuota(juan), openLTablets.calcularCuota(juan));
    }

    @Test
    public void becario() {
        assertEquals(reglas.calcularCuota(maria), openLTablets.calcularCuota(maria));
    }

    @Test
    public void conyuge() {
        assertEquals(reglas.calcularCuota(pedro), openLTablets.calcularCuota(pedro));
    }

    @Test
    public void agenteUNSLConLicencia() {
        assertEquals(reglas.calcularCuota(ana), openLTablets.calcularCuota(ana));
    }
